...
<tr>
<td width="33%"><a href="https://nishant-zfyii.github.io/terra-perceive/m5-pipeline"><img src="docs/assets/m5/clip1_tracker_overlay_thumb.jpg" alt="M11 perception loop" width="100%"/></a><br/><b>M11 — Tracker-safety perception loop</b><br/>YOLO detector → camera-LiDAR projection → SORT → safety supervisor → NATS audit trail. End-to-end loop with replay tooling.</td>
<td width="33%"><a href="https://nishant-zfyii.github.io/terra-perceive/m12-probabilistic-traversability"><img src="docs/assets/m12/confidence_compare_frame_01500.png" alt="M12 probabilistic traversability" width="100%"/></a><br/><b>M12 — Probabilistic traversability</b><br/>Range-dependent LiDAR noise σ(r) propagated through per-cell PCA → calibrated confidence with no artifact cliff. Full-sequence ablation matches analytic prediction within 2%.</td>
